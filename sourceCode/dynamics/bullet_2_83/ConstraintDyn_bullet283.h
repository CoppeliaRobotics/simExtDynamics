...
class CConstraintDyn_bullet283 : public CConstraintDyn
{
public:
	// ShapeA - joint - shapeB
	CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyJoint* joint,btDiscreteDynamicsWorld* bulletWorld); // Bullet

	// ShapeA - joint - dummyA - dummyB - shapeB
	CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyJoint* joint,CDummyDummy* loopClosureDummyA,CDummyDummy* loopClosureDummyB,btDiscreteDynamicsWorld* bulletWorld); // Bullet

	// ShapeA - dummyA - dummyB - shapeB
	CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyDummy* dummyOnParent,CDummyDummy* dummyOnChild,btDiscreteDynamicsWorld* bulletWorld); // Bullet

	// ShapeA - force sensor - shapeB
	CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyForceSensor* forceSensor,btDiscreteDynamicsWorld* bulletWorld); // Bullet

	// ShapeA - force sensor - dummyA - dummyB - shapeB
	CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyForceSensor* forceSensor,CDummyDummy* loopClosureDummyA,CDummyDummy* loopClosureDummyB,btDiscreteDynamicsWorld* bulletWorld); // Bullet

	virtual ~CConstraintDyn_bullet283();
...
protected:
	...
	btJointFeedback _bulletJointfeedbackStructure;
};
