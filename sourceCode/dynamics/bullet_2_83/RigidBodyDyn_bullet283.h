...
class CRigidBodyDyn_bullet283 : public CRigidBodyDyn
{
public:
	CRigidBodyDyn_bullet283(CDummyShape* shape,CCollShapeDyn* collShapeDyn,bool forceStatic,bool forceNonRespondable,btDiscreteDynamicsWorld* bulletWorld); // Bullet
	virtual ~CRigidBodyDyn_bullet283();
