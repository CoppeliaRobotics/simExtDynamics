...
CRigidBodyDyn_bullet283::CRigidBodyDyn_bullet283(CDummyShape* shape,CCollShapeDyn* collShapeDyn,bool forceStatic,bool forceNonRespondable,btDiscreteDynamicsWorld* bulletWorld)
{
    _rigidBodyID=-1;
    ...
    btRigidBody::btRigidBodyConstructionInfo rbInfo(mass,myMotionState,((CCollShapeDyn_bullet283*)_collisionShapeDyn)->getBtCollisionShape(),localInertia);
...
C7Vector CRigidBodyDyn_bullet283::getInertiaFrameTransformation()
...
C7Vector CRigidBodyDyn_bullet283::getShapeFrameTransformation()
{ // return value is unscaled (relative to CoppeliaSim)
    C7Vector tr;
...
btRigidBody* CRigidBodyDyn_bullet283::getBtRigidBody()
{
    return(_rigidBody);
}

void CRigidBodyDyn_bullet283::reportVelocityToShape(CDummyShape* shape)
{
...
void CRigidBodyDyn_bullet283::handleAdditionalForcesAndTorques(CDummyShape* shape)
{
...
void CRigidBodyDyn_bullet283::reportShapeConfigurationToRigidBody_forKinematicBody(CDummyShape* shape,float t,float cumulatedTimeStep)
{
...
void CRigidBodyDyn_bullet283::applyCorrectEndConfig_forKinematicBody()
{
    if (_bodyIsKinematic&&_applyBodyToShapeTransf_kinematicBody)
    { // static & moved (the desired movement was large enough)
